            ...
            <div className="flex flex-row">
              ...
              <div className="flex flex-col basis-1/3 ">
                ...
                <p className="font-normal text-lg tracking-tighter pt-7">
                  ...
                  (APS-C) sensor, and lightning fast autofocus, the EOS R10
                  camera brings some of the best features from the growing EOS R
                  Series to a sleek, lightweight design
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="flex flex-row">
              <div className="flex flex-col basis-5/12 ">
                ...
                <p className="font-normal text-lg tracking-tighter pt-2 pl-2">
                  ...
                  lightweight, compact design. Pair with a Canon RF-S/RF lens
                  for a high-performance setup that fits easily and comfortably
                  in your hand.
                </p>
              </div>
